...
<body class="app">
    ...
    <div>
        <div class="sidebar">
            <div class="sidebar-inner">
                <div class="sidebar-logo">
                    <div class="peers ai-c fxw-nw">
                        <div class="peer peer-greed">
                            <a class="sidebar-link td-n" href="../../polygon/adminator/index.html" class="td-n">
                                <div class="peers ai-c fxw-nw">
                                    <div class="peer">
                                        <div class="logo">
                                            <script type="text/javascript">
                                            //<![CDATA[
                                            window.__mirage2 = { petok: "294816f1ba6bcd115e5d1d47fe230bb973a7a21e-1533109232-1800" };
                                            //]]>

                                            </script>
                                            <script type="text/javascript" src="/admin_assests/js/mirage2.min.js"></script>
                                            <img data-cfsrc="/admin_assets/img/logo.png" alt="" style="display:none;visibility:hidden;">
                                            <noscript><img src="/admin_assets/img/logo.png" alt=""></noscript>
                                        </div>
                                    </div>
                                    <div class="peer peer-greed">
                ...
                <ul class="sidebar-menu scrollable pos-r">
                    <li class="nav-item mT-30 active"><a class="sidebar-link" href="../../polygon/adminator/index.html" default><span class="icon-holder"><i class="c-blue-500 ti-home"></i> </span><span class="title">Dashboard</span></a></li>
                    <li class="nav-item"><a class="sidebar-link" href="../../polygon/adminator/email.html"><span class="icon-holder"><i class="c-brown-500 ti-email"></i> </span><span class="title">Email</span></a></li>
                    <li class="nav-item"><a class="sidebar-link" href="../../polygon/adminator/compose.html"><span class="icon-holder"><i class="c-blue-500 ti-share"></i> </span><span class="title">Compose</span></a></li>
                    <li class="nav-item"><a class="sidebar-link" href="../../polygon/adminator/calendar.html"><span class="icon-holder"><i class="c-deep-orange-500 ti-calendar"></i> </span><span class="title">Calendar</span></a></li>
                    <li class="nav-item"><a class="sidebar-link" href="../../polygon/adminator/chat.html"><span class="icon-holder"><i class="c-deep-purple-500 ti-comment-alt"></i> </span><span class="title">Chat</span></a></li>
                    <li class="nav-item"><a class="sidebar-link" href="../../polygon/adminator/charts.html"><span class="icon-holder"><i class="c-indigo-500 ti-bar-chart"></i> </span><span class="title">Charts</span></a></li>
                    <li class="nav-item"><a class="sidebar-link" href="../../polygon/adminator/forms.html"><span class="icon-holder"><i class="c-light-blue-500 ti-pencil"></i> </span><span class="title">Forms</span></a></li>
                    <li class="nav-item dropdown"><a class="sidebar-link" href="../../polygon/adminator/ui.html"><span class="icon-holder"><i class="c-pink-500 ti-palette"></i> </span><span class="title">UI Elements</span></a></li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span class="icon-holder"><i class="c-orange-500 ti-layout-list-thumb"></i> </span><span class="title">Tables</span> <span class="arrow"><i class="ti-angle-right"></i></span></a>
                        <ul class="dropdown-menu">
                            <li><a class="sidebar-link" href="../../polygon/adminator/basic-table.html">Basic Table</a></li>
                            <li><a class="sidebar-link" href="../../polygon/adminator/datatable.html">Data Table</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span class="icon-holder"><i class="c-purple-500 ti-map"></i> </span><span class="title">Maps</span> <span class="arrow"><i class="ti-angle-right"></i></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="../../polygon/adminator/google-maps.html">Google Map</a></li>
                            <li><a href="../../polygon/adminator/vector-maps.html">Vector Map</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span class="icon-holder"><i class="c-red-500 ti-files"></i> </span><span class="title">Pages</span> <span class="arrow"><i class="ti-angle-right"></i></span></a>
                        <ul class="dropdown-menu">
                            <li><a class="sidebar-link" href="../../polygon/adminator/404.html">404</a></li>
                            <li><a class="sidebar-link" href="../../polygon/adminator/500.html">500</a></li>
                            <li><a class="sidebar-link" href="../../polygon/adminator/signin.html">Sign In</a></li>
                            <li><a class="sidebar-link" href="../../polygon/adminator/signup.html">Sign Up</a></li>
                        </ul>
                    </li>
        ...
        <div class="page-container">
                    ...
                    <ul class="nav-right">
                                    ...
                                    <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                                        <li>
                                            <a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                                <div class="peer mR-15"><img class="w-3r bdrs-50p" data-cfsrc="/admin_assets/img/1.jpg" alt="" style="display:none;visibility:hidden;">
                                                    <noscript><img class="w-3r bdrs-50p" src="/admin_assets/img/1.jpg" alt=""></noscript>
                                                </div>
                                        ...
                                        <li>
                                            <a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                                <div class="peer mR-15"><img class="w-3r bdrs-50p" data-cfsrc="/admin_assets/img/2.jpg" alt="" style="display:none;visibility:hidden;">
                                                    <noscript><img class="w-3r bdrs-50p" src="/admin_assets/img/2.jpg" alt=""></noscript>
                                                </div>
                                        ...
                                        <li>
                                            <a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                                <div class="peer mR-15"><img class="w-3r bdrs-50p" data-cfsrc="/admin_assets/img/3.jpg" alt="" style="display:none;visibility:hidden;">
                                                    <noscript><img class="w-3r bdrs-50p" src="/admin_assets/img/3.jpg" alt=""></noscript>
                                                </div>
                        ...
                        <li class="dropdown">
                            <a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                                <div class="peer mR-10"><img class="w-2r bdrs-50p" data-cfsrc="/admin_assets/img/10.jpg" alt="" style="display:none;visibility:hidden;">
                                    <noscript><img class="w-2r bdrs-50p" src="/admin_assets/img/10.jpg" alt=""></noscript>
                                </div>
                                    ...
                                    <div class="layer w-100">
                                        <div class="bgc-grey-200 p-20 gapY-15">
                                            <div class="peers fxw-nw">
                                                <div class="peer mR-20"><img class="w-2r bdrs-50p" data-cfsrc="/admin_assets/img/11.jpg" alt="" style="display:none;visibility:hidden;">
                                                    <noscript><img class="w-2r bdrs-50p" src="/admin_assets/img/11.jpg" alt=""></noscript>
                                                </div>
                                                <div class="peer peer-greed">
                                            ...
                                            <div class="peers fxw-nw ai-fe">
                                                <div class="peer ord-1 mL-20"><img class="w-2r bdrs-50p" data-cfsrc="/admin_assets/img/12.jpg" alt="" style="display:none;visibility:hidden;">
                                                    <noscript><img class="w-2r bdrs-50p" src="/admin_assets/img/12.jpg" alt=""></noscript>
                                                </div>
            ...
            <footer class="bdT ta-c p-30 lh-0 fsz-sm c-grey-600"><span>Copyright © 2017 Designed by <a href="../../index.html" target="_blank" title="Colorlib">Colorlib</a>. All rights reserved.</span>
    ...
    <script type="text/javascript" src="/admin_assets/js/vendor.js"></script>
